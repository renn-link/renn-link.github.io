(function(e) {
    function u(u) {
        ...
        if (u)
            u.preventDefault();
        var a = e(this),
            f = e(a).parent().find('.img').eq(0).data("url");
        if (!f)
            return;
    ...
    function a() {
        var t = i.parent().prev();
        if (t.length == 0 || t.hasClass('grid-sizer'))
            t = e(".mask:last").parent();
        console.log(t);
        t.find(".mask").trigger("click")
    }

    function f() {
        var t = i.parent().next();
        if (t.length == 0 || t.hasClass('grid-sizer'))
            t = e(".mask:first").parent();
        t.find(".mask").trigger("click")
    }
    ...
    (function() {
        ...
        if (e("div[class$='item']>img").length == 1)
            e("div[class$='item']>img")[0].addClass("zoom");
        e(".mask").on("click", u)
    })();
    (function() {
